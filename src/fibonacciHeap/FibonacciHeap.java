...
public final class FibonacciHeap<T> {
     ...
     * priority.  Its priority must be a valid int, so you cannot set the
     * priority to NaN.
     *
     ...
     * it's a valid int and throws an IllegalArgumentException otherwise.
     *
